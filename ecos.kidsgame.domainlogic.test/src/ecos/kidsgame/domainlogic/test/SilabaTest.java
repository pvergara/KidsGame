...
public class SilabaTest {
	...
	Silaba unaSilabaCreadaConUnFonema = new Silaba(Fonema.desde("ca"), Representacion.desde("ca"));
	Silaba otraSilabaCreadaConElMismoFonema = new Silaba(Fonema.desde("ca"), Representacion.desde("ca"));

	assertEquals(unaSilabaCreadaConUnFonema, otraSilabaCreadaConElMismoFonema);

	Silaba otraSilabaCreadaConOtroFonema = new Silaba(Fonema.desde("za"), Representacion.desde("ca"));
	assertFalse(unaSilabaCreadaConUnFonema.equals(otraSilabaCreadaConOtroFonema));
    }
