...
import ecos.kidsgame.game.viewmodel.EncontrarSilabaViewModel;

public class EncontrarSilabaActivity extends RoboActivity {
	...
	@InjectView(R.id.encontrarSilabaRepetir)
	Button mRepetir;

	@Inject
	EncontrarSilabaViewModel mEncontrarSilabaViewModel;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.encontrarsilaba);

		mBindingManager = mEncontrarSilabaViewModel.getBindingManager();
		...
		mRepetir.setOnClickListener(mRepetirOnClick);
	...
	private OnClickListener mIniciarOnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			mEncontrarSilabaViewModel.iniciar();

		}
	};

	private OnClickListener mRepetirOnClick = new OnClickListener() {

		public void onClick(View v) {
			mEncontrarSilabaViewModel.repetirSilabaSeleccionada();
	...
	private BindingAction mBindingActionIniciarVisibility = new BindingAction() {
		...
		public void fireAction(Object sourceElementValue) {
			mIniciar.setVisibility(convertirBoleanAVisbility((Boolean) sourceElementValue));
	...
	private BindingAction mBindingActionRepetirVisibility = new BindingAction() {
		...
		public void fireAction(Object sourceElementValue) {
			mRepetir.setVisibility(convertirBoleanAVisbility((Boolean) sourceElementValue));
	...
	private OnClickListener mSilabasOnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			mEncontrarSilabaViewModel.jugar(((SilabaDto) silaba.getTag()));
		}
	};

	public void explicarClick(View v) {
		mEncontrarSilabaViewModel.explicar();
	}
}